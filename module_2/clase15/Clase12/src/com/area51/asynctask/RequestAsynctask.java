...
import com.area51.clase12.ResultadoActivity;
...
public class RequestAsynctask {
	...
	public void resultadoVotacion( String url ){
		
		Log.d(TAG, "url:" + url);
		
		ResultadoVotacion obj = new ResultadoVotacion();
		obj.execute(url);
	...
	public class ResultadoVotacion extends AsyncTask< String, Void, String > {
		...
		protected void onPostExecute(String result){
			...
			( ( ResultadoActivity ) contexto  ).resultadoVotacion(result);
