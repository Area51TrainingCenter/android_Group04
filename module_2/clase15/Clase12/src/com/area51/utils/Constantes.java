...
public class Constantes {
	...
	//public static String API = "http://192.168.0.76/area51api/";
	
	
	public static String SECTION_LOGUEO = "logueo.php?";
	public static String SECTION_VOTACION = "votacion.php?";
	public static String SECTION_VOTACION_INGRESO = "ingresa_votacion.php?";
	public static String SECTION_VOTACION_RESULTADO = "resultado_votacion.php?";
	public static String SECTION_ESTADO_USUARIO = "estado_usuario.php?";
	...
	//Para SQLite
	public static String DB_NAME = "coperando.db";
